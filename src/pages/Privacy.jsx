...
function Privacy() {
  const sections = [
    {
      title: 'Introduction',
      content: `This Privacy Policy explains how RentVerse ("we," "us," or "our") collects, uses, and protects your personal information when you use our platform. We are committed to ensuring the privacy and security of your personal and financial information, including cryptocurrency transactions.`
    },
    {
    ...
    <div className="min-h-screen bg-secondary-50 py-16 dark:bg-secondary-900">
      <div className="container">
        ...
        >
          ...
          <div className="bg-white rounded-lg shadow-md p-8 dark:bg-secondary-800 dark:shadow-none">
            <div className="space-y-8">
              {sections.map((section, index) => (
                ...
                >
                  ...
                  <div className="text-secondary-600 whitespace-pre-line dark:text-secondary-300">
                    {section.content}
                  </div>
                </motion.div>
              ))}
