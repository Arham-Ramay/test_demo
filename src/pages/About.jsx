          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <motion.div
                ...
                className="bg-white rounded-lg p-6 text-center shadow-md dark:bg-secondary-800 dark:shadow-none"
              >
                <stat.icon className="w-8 h-8 mx-auto mb-4 text-primary-600 dark:text-primary-400" />
                <div className="text-3xl font-bold text-secondary-900 mb-2 dark:text-white">{stat.value}</div>
      ...
      <section className="py-16 bg-white dark:bg-secondary-800">
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="bg-primary-50 p-4 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-4 dark:bg-secondary-700">
            ...
            {team.map((member, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-primary-600 font-medium mb-4 dark:text-primary-400">{member.role}</p>
                  <p className="text-secondary-600 text-sm dark:text-secondary-300">{member.bio}</p>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
            ...
            >
              ...
              <p className="text-secondary-600 dark:text-secondary-300">Real Estate Tech Awards 2024</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-secondary-600 dark:text-secondary-300">Forbes Innovation 2024</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-secondary-600 dark:text-secondary-300">Blockchain Security Excellence 2024</p>
            </motion.div>
          </div>
        </div>
      </section>
