...
function Footer() {
  return (
    <footer className="bg-secondary-900 text-white dark:border-t dark:border-secondary-700">
      <div className="container py-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center text-secondary-300 text-sm">
                ...
                <span>contact@RentVerse.com</span>
              </li>
              <li className="flex items-center text-secondary-300 text-sm">
        ...
        <div className="border-t border-secondary-700 mt-8 pt-8 text-center text-secondary-300 text-sm">
          <p>&copy; {new Date().getFullYear()} RentVerse. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
